...
public class ODP {
    public static void main(String[] args) {
        ...
        NotificationObserver obj1 = new EmailObserver(iphoneObservable,"ayushwinner@gmail.com");
        NotificationObserver obj2 = new MobileObserver(iphoneObservable,"8800519214");
